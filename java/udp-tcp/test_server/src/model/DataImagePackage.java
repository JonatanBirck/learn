...
public class DataImagePackage 
{
    ...
    public DataImagePackage(){}
            
    public DataImagePackage( byte type, short arg0, short arg1, byte[] body ) 
    {
        this.type = type;
        this.pieces = pieces;
        this.index = index;
    ...
    public static DataImagePackage read( byte[] bytes )
    {
        ...
        DataImagePackage udp = new DataImagePackage();
    ...
    public static List<DataImagePackage> createPackages( byte[] bytes )
    {
        List<DataImagePackage> packages = new ArrayList<>();
    ...
    private static DataImagePackage newPackage( byte type, short pieces, short index, byte[] bytes )
    {
        ...
        return new DataImagePackage( type, pieces, index, body );  
    }
    
    public static byte[] dataPackagesToImageByte( List<DataImagePackage> dataPackages )
    {   
        int total_bytes = 0;
        
        short pieces = dataPackages.get(0).getPieces();
        
        ByteBuffer buffer = ByteBuffer.allocate(( pieces * DataImagePackage.LENGTH_PACKAGE ) );
        
        short index = 0;
        
        while( index < pieces )
        {
            for( DataImagePackage dataPackage : dataPackages )
            {
